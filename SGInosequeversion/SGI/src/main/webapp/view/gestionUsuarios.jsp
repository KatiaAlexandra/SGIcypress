<%@ page import="mx.edu.utez.sgi.dao.UserDao" %>
<%@ page import="mx.edu.utez.sgi.entities.User" %>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <% if (email.equals("20233tn166@utez.edu.mx") && usuario.equals("katia")
                || email.equals("carlosrodriguez@utez.edu.mx") && usuario.equals("carlos")) { %>
        <li id="ocultarUsuario" class="nav-item active">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-md-12 mb-4">
                        <div class="card border-left-success shadow h-100 py-2">
                            <div class="card-body">
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    <h1 class="h5 mb-0 text-gray-800">Lista de usuarios</h1>
                                    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#añadir">Añadir usuario</button>
                                </div>
                                <div class="table-responsive mt-3">
                                    <table id="articlesTable" class="table table-hover">
                                        ...
                                        <tbody>
                                        <%
                                            // Instancia del DAO para obtener la lista de usuarios
                                            UserDao UserDao = new UserDao();
                                            List<User> users = UserDao.viewUser();
                                            // Recorrer la lista de usuarios y crear una opción para cada uno
                                            for (User user : users) {
                                        %>
                                        <tr>
                                            <td id="userID"><%= i++ %></td>
                                            ...
                                            <td>
                                                <div class="boton-modal" style="display: flex; justify-content: center;">
                                                    <div class="acciones">
                                                        <button class="btn btn-warning" onclick="putUserInformation(<%=user.getId()%>)" data-bs-toggle="modal" data-bs-target="#editar">
                                                            <i class="fas fa-edit"></i>
                                                        </button>
                                                        <button class="btn btn-danger" onclick="putUserIdOnForm(<%=user.getId()%>)" data-bs-toggle="modal" data-bs-target="#deleteModal">
...
<div class="modal fade" id="añadir" tabindex="-1" aria-labelledby="añadirLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="añadirLabel">Añadir usuario</h5>
                <button type="button" class="btn-close-custom" data-bs-dismiss="modal" aria-label="Close">&times;</button>
            </div>
            <div class="modal-body">
                <form action="<%=context%>/CreateUserServlet" method="post">
...
<div class="modal fade" id="editar" tabindex="-1" aria-labelledby="actualizarLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="actualizarLabel">Editar usuario</h5>
                <button type="button" class="btn-close-custom" data-bs-dismiss="modal" aria-label="Close">&times;</button>
            </div>
            <div class="modal-body">
                <form action="<%=context%>/UpdateUser" method="post">
                    ...
                    <div class="mb-3">
                        <label for="u_username" class="form-label">Nombre</label>
                        <input type="text" class="form-control" id="u_username" name="u_username" required>
                    </div>
                    <div class="mb-3">
                        <label for="u_email" class="form-label">Correo</label>
