...
<head>
    ...
    <style>
        ...
        .button-container button {
            ...
            min-height: 40px; /* Reduce la altura mínima */
            text-align: center;
                        ...
                        <div class="card border-left-success shadow h-100 py-2">
                            <div class="card-body">
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    ...
                                    <button id="exportExcel" type="button" class="btn btn-outline-success" >Exportar a Excel</button>
                                    <button id="exportPDF" type="button" class="btn btn-outline-danger" >Exportar a PDF</button>
